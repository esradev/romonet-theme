...
<!-- Author Hero -->
<section class="bg-linear-to-br from-gray-900 via-gray-900 to-green-900/20 py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col md:flex-row items-center gap-8">
      <img src="/placeholder.svg?height=200&width=200" alt="John Smith" class="w-48 h-48 rounded-full border-4 border-green-500/30">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
      <div class="bg-gray-800/50 p-6 rounded-xl text-center">
        <div class="text-3xl font-bold text-green-400 mb-2">127</div>
        <div class="text-gray-400">Articles</div>
      </div>
      <div class="bg-gray-800/50 p-6 rounded-xl text-center">
        <div class="text-3xl font-bold text-green-400 mb-2">45K</div>
        <div class="text-gray-400">Readers</div>
      </div>
      <div class="bg-gray-800/50 p-6 rounded-xl text-center">
        <div class="text-3xl font-bold text-green-400 mb-2">892</div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div class="bg-gray-800/50 p-6 rounded-xl">
        <i class="fas fa-cloud text-4xl text-green-400 mb-4"></i>
...
<section class="py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-12">
      ...
      <a href="blog.html" class="text-green-400 hover:text-green-300 transition">View All <i class="fas fa-arrow-right ml-2"></i></a>
    </div>

    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Article 1 -->
      <article class="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 hover:border-green-500/50 transition group">
        ...
        <div class="p-6">
          ...
          <h3 class="text-xl font-semibold mb-3 group-hover:text-green-400 transition">
          ...
          <a href="blog-post.html" class="text-green-400 hover:text-green-300 transition inline-flex items-center">

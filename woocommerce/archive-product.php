  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ category: 'all', sort: 'popular' }">
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
      ...
      <div class="flex gap-2 flex-wrap">
        <button @click="category = 'all'" :class="category === 'all' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'" class="px-4 py-2 rounded-lg hover:bg-green-600 transition">
          All Services
        </button>
        <button @click="category = 'sms'" :class="category === 'sms' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'" class="px-4 py-2 rounded-lg hover:bg-green-600 transition">
          SMS Panel
        </button>
        <button @click="category = 'hosting'" :class="category === 'hosting' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'" class="px-4 py-2 rounded-lg hover:bg-green-600 transition">
          Hosting
        </button>
        <button @click="category = 'domain'" :class="category === 'domain' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'" class="px-4 py-2 rounded-lg hover:bg-green-600 transition">
          Domains
        </button>
      </div>
      ...
      <!-- Sort Dropdown -->
      <div>
        <select x-model="sort" class="bg-gray-700 text-white px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-green-500">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-green-500 transition group">
        <div class="bg-linear-to-br from-green-500/20 to-green-500/20 p-8 text-center">
          <div class="w-16 h-16 bg-linear-to-br from-green-500 to-green-500 rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
            </svg>
          </div>
          <h3 class="text-2xl font-bold mb-2">SMS Panel Starter</h3>
          <div class="text-3xl font-bold text-green-400">$29<span class="text-base text-gray-400">/month</span></div>
        </div>
        <div class="p-6">
          ...
          <div class="flex gap-2">
            ...
            <button class="bg-linear-to-r from-green-500 to-green-500 text-white px-6 py-2 rounded-lg hover:from-green-600 hover:to-green-600 transition">
              Add to Cart
            </button>
          </div>
        </div>
      ...
      <div class="bg-gray-800 rounded-xl overflow-hidden border border-green-500 hover:border-green-500 transition group relative">
        ...
        <div class="bg-linear-to-br from-green-500/20 to-green-500/20 p-8 text-center">
          ...
          <div class="text-3xl font-bold text-green-400">$79<span class="text-base text-gray-400">/month</span></div>
        </div>
        <div class="p-6">
          <ul class="space-y-3 mb-6">
            <li class="flex items-center text-gray-300">
      ...
      <div class="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-green-500 transition group">
        <div class="bg-linear-to-br from-green-500/20 to-emerald-500/20 p-8 text-center">
          <div class="w-16 h-16 bg-linear-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01"></path>
            </svg>
          </div>
          <h3 class="text-2xl font-bold mb-2">Shared Hosting</h3>
          <div class="text-3xl font-bold text-green-400">$9<span class="text-base text-gray-400">/month</span></div>
        </div>
        <div class="p-6">
          <ul class="space-y-3 mb-6">
            <li class="flex items-center text-gray-300">
          ...
          <div class="flex gap-2">
            ...
            <button class="bg-linear-to-r from-green-500 to-emerald-500 text-white px-6 py-2 rounded-lg hover:from-green-600 hover:to-emerald-600 transition">
              Add to Cart
            </button>
          </div>
        </div>
      ...
      <div class="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-green-500 transition group">
        <div class="bg-linear-to-br from-teal-500/20 to-green-500/20 p-8 text-center">
          <div class="w-16 h-16 bg-linear-to-br from-teal-500 to-green-500 rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-6">
          ...
          <div class="flex gap-2">
            ...
            <button class="bg-linear-to-r from-teal-500 to-green-500 text-white px-6 py-2 rounded-lg hover:from-teal-600 hover:to-green-600 transition">
              Add to Cart
            </button>
          </div>
        </div>

...
<!-- Search Header -->
<section class="bg-linear-to-br from-gray-900 via-gray-900 to-sky-900/20 py-12">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
      <p class="text-gray-400">
        ...
        <span class="text-sky-400 font-semibold" x-text="query || 'your search'"></span>
      </p>
    </div>

    <!-- Filter Tabs -->
    <div class="flex gap-4 mb-8 border-b border-gray-800 overflow-x-auto">
      <button @click="activeTab = 'all'" :class="activeTab === 'all' ? 'text-sky-400 border-sky-400' : 'text-gray-400 border-transparent'" class="pb-4 border-b-2 transition whitespace-nowrap">
        All Results (47)
      </button>
      <button @click="activeTab = 'services'" :class="activeTab === 'services' ? 'text-sky-400 border-sky-400' : 'text-gray-400 border-transparent'" class="pb-4 border-b-2 transition whitespace-nowrap">
        Services (12)
      </button>
      <button @click="activeTab = 'articles'" :class="activeTab === 'articles' ? 'text-sky-400 border-sky-400' : 'text-gray-400 border-transparent'" class="pb-4 border-b-2 transition whitespace-nowrap">
        Articles (28)
      </button>
      <button @click="activeTab = 'products'" :class="activeTab === 'products' ? 'text-sky-400 border-sky-400' : 'text-gray-400 border-transparent'" class="pb-4 border-b-2 transition whitespace-nowrap">
        Products (7)
      </button>
    </div>
    ...
    <div class="space-y-6">
      <!-- Service Result -->
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          <div class="bg-sky-600/20 p-3 rounded-lg">
            <i class="fas fa-sms text-2xl text-sky-400"></i>
          </div>
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Service</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="service-sms.html" class="hover:text-sky-400 transition">SMS Panel Manager</a>
            </h3>
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            ...
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="single-product.html" class="hover:text-sky-400 transition">Cloud Hosting Pro</a>
            </h3>
            <p class="text-gray-400 mb-4">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          <div class="bg-sky-600/20 p-3 rounded-lg">
            <i class="fas fa-newspaper text-2xl text-sky-400"></i>
          </div>
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Blog Article</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="blog-post.html" class="hover:text-sky-400 transition">How to Choose the Right Hosting Plan</a>
            </h3>
            <p class="text-gray-400 mb-4">
              ...complete guide to selecting the perfect <mark class="bg-sky-500/20 text-sky-300 px-1">hosting</mark> solution for your business needs. Learn about shared, VPS, and dedicated <mark class="bg-sky-500/20 text-sky-300 px-1">hosting</mark> options...
            </p>
            <div class="flex items-center gap-4 text-sm text-gray-500">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          <div class="bg-sky-600/20 p-3 rounded-lg">
            <i class="fas fa-globe text-2xl text-sky-400"></i>
          </div>
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Service</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="service-domains.html" class="hover:text-sky-400 transition">Domain Registration</a>
            </h3>
            <p class="text-gray-400 mb-4">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Blog Article</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="blog-post.html" class="hover:text-sky-400 transition">SMS Marketing Best Practices</a>
            </h3>
            <p class="text-gray-400 mb-4">
              ...effective <mark class="bg-sky-500/20 text-sky-300 px-1">SMS</mark> campaigns that engage customers and drive conversions. Discover the optimal sending times, message length, and personalization techniques...
            </p>
            <div class="flex items-center gap-4 text-sm text-gray-500">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          <div class="bg-sky-600/20 p-3 rounded-lg">
            <i class="fas fa-database text-2xl text-sky-400"></i>
          </div>
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Product</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="single-product.html" class="hover:text-sky-400 transition">VPS Hosting Enterprise</a>
            </h3>
            <p class="text-gray-400 mb-4">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Blog Article</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="blog-post.html" class="hover:text-sky-400 transition">Domain Name Selection Guide</a>
            </h3>
            <p class="text-gray-400 mb-4">
              ...choosing a <mark class="bg-sky-500/20 text-sky-300 px-1">domain</mark> name that boosts your brand and SEO performance. Learn about TLD selection, keyword optimization, and brandability...
            </p>
            <div class="flex items-center gap-4 text-sm text-gray-500">
      ...
      <article class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-sky-500/50 transition">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <span class="text-xs text-gray-400 uppercase tracking-wide">Service</span>
            <h3 class="text-xl font-semibold mb-2 mt-1">
              <a href="service-hosting.html" class="hover:text-sky-400 transition">Web Hosting Solutions</a>
            </h3>
            <p class="text-gray-400 mb-4">

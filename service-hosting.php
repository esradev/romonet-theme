    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight text-balance">
          Reliable & Fast <span class="text-sky-400">Web Hosting</span>
        </h1>
        ...
        <div class="flex flex-wrap gap-4">
          <a href="#pricing" class="px-8 py-4 bg-linear-to-r from-sky-600 to-sky-600 hover:from-sky-700 hover:to-sky-700 rounded-lg font-semibold transition-all">
            View Plans
          </a>
          <a href="contact.html" class="px-8 py-4 border border-slate-700 hover:border-sky-500 rounded-lg font-semibold transition-colors">
            Contact Sales
          </a>
        </div>
      </div>
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-sky-500/50 transition-colors">
        <div class="w-14 h-14 bg-sky-500/10 rounded-lg flex items-center justify-center mb-6">
          <i class="fas fa-cloud text-sky-400 text-2xl"></i>
        </div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-sky-500/50 transition-colors">
        <div class="w-14 h-14 bg-sky-500/10 rounded-lg flex items-center justify-center mb-6">
          <i class="fas fa-tachometer-alt text-sky-400 text-2xl"></i>
        </div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-sky-500/50 transition-colors">
        <div class="w-14 h-14 bg-sky-500/10 rounded-lg flex items-center justify-center mb-6">
          <i class="fas fa-infinity text-sky-400 text-2xl"></i>
        </div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-sky-500/50 transition-colors">
        ...
        <button onclick="addToCart('Hosting Starter', 4.99)" class="w-full px-6 py-3 border border-slate-700 hover:border-sky-500 hover:bg-sky-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      ...
      <div class="bg-linear-to-br from-sky-900/20 to-sky-900/20 border-2 border-sky-500 rounded-xl p-8 relative">
        ...
        <button onclick="addToCart('Hosting Business', 9.99)" class="w-full px-6 py-3 bg-linear-to-r from-sky-600 to-sky-600 hover:from-sky-700 hover:to-sky-700 rounded-lg font-semibold transition-all">
          Add to Cart
        </button>
      </div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-sky-500/50 transition-colors">
        ...
        <button onclick="addToCart('Hosting Enterprise', 24.99)" class="w-full px-6 py-3 border border-slate-700 hover:border-sky-500 hover:bg-sky-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
    </div>

...
<section class="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-center">
    <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight text-balance">
      Latest News & <span class="text-green-400">Insights</span>
    </h1>
...
<section class="py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto">
    <div class="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden hover:border-green-500/50 transition-colors">
      <div class="grid lg:grid-cols-2 gap-0">
        <div class="relative h-64 lg:h-auto">
          <img src="/placeholder.svg?height=400&width=600" alt="Featured Post" class="w-full h-full object-cover">
          <div class="absolute top-4 left-4">
            <span class="px-3 py-1 bg-green-500 text-white text-sm font-semibold rounded-full">Featured</span>
          </div>
        </div>
        <div class="p-8 lg:p-12 flex flex-col justify-center">
          ...
          <a href="#" class="inline-flex items-center gap-2 text-green-400 hover:text-green-300 font-semibold transition-colors">
...
<section class="py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto">
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Blog Post 1 -->
      <article class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden hover:border-green-500/50 transition-colors">
        <img src="/placeholder.svg?height=250&width=400" alt="SMS Guide" class="w-full h-48 object-cover">
        <div class="p-6">
          <div class="flex items-center gap-2 mb-3">
            <span class="px-3 py-1 bg-green-500/10 text-green-400 text-xs font-semibold rounded-full">SMS</span>
      ...
      <article class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden hover:border-green-500/50 transition-colors">
        ...
        <div class="p-6">
          <div class="flex items-center gap-2 mb-3">
            <span class="px-3 py-1 bg-green-500/10 text-green-400 text-xs font-semibold rounded-full">Hosting</span>
      ...
      <article class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden hover:border-green-500/50 transition-colors">
        ...
        <div class="p-6">
          <div class="flex items-center gap-2 mb-3">
            <span class="px-3 py-1 bg-green-500/10 text-green-400 text-xs font-semibold rounded-full">Domains</span>
      ...
      <article class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden hover:border-green-500/50 transition-colors">
        ...
        <div class="p-6">
          <div class="flex items-center gap-2 mb-3">
            <span class="px-3 py-1 bg-green-500/10 text-green-400 text-xs font-semibold rounded-full">Cloud</span>
    ...
    <div class="flex items-center justify-center gap-2 mt-12">
      <button class="px-4 py-2 border border-slate-700 rounded-lg hover:border-green-500 transition-colors">
        <i class="fas fa-chevron-left"></i>
      </button>
      <button class="px-4 py-2 bg-green-600 rounded-lg">1</button>
      <button class="px-4 py-2 border border-slate-700 rounded-lg hover:border-green-500 transition-colors">2</button>
      <button class="px-4 py-2 border border-slate-700 rounded-lg hover:border-green-500 transition-colors">3</button>
      <button class="px-4 py-2 border border-slate-700 rounded-lg hover:border-green-500 transition-colors">
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-green-900/20 to-green-900/20">
  <div class="max-w-4xl mx-auto text-center">
    ...
    <form class="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
      <input type="email" placeholder="Enter your email" class="flex-1 px-6 py-4 bg-slate-900 border border-slate-800 rounded-lg focus:outline-none focus:border-green-500 transition-colors">
      <button type="submit" class="px-8 py-4 bg-linear-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 rounded-lg font-semibold transition-all">
        Subscribe
      </button>
    </form>
  </div>

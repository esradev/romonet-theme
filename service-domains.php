    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight text-balance">
          Find Your Perfect <span class="text-green-400">Domain Name</span>
        </h1>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-lg p-2 flex gap-2 mb-6" x-data="{ domain: '' }">
          ...
          <button class="px-6 py-3 bg-linear-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 rounded-lg font-semibold transition-all">
            Search
          </button>
        </div>
        <p class="text-slate-400 text-sm">Starting from <span class="text-green-400 font-semibold">$9.99/year</span></p>
      </div>
      <div class="relative">
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        ...
        <button onclick="addToCart('.com Domain', 12.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        ...
        <button onclick="addToCart('.net Domain', 14.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        <div class="flex items-center justify-between mb-4">
          <span class="text-2xl font-bold text-green-400">.org</span>
          <span class="text-xl font-semibold">$13.99</span>
        </div>
        <p class="text-slate-400 text-sm mb-4">Great for organizations</p>
        <button onclick="addToCart('.org Domain', 13.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        ...
        <button onclick="addToCart('.io Domain', 34.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        <div class="flex items-center justify-between mb-4">
          <span class="text-2xl font-bold text-green-400">.co</span>
          <span class="text-xl font-semibold">$24.99</span>
        </div>
        <p class="text-slate-400 text-sm mb-4">Business alternative</p>
        <button onclick="addToCart('.co Domain', 24.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        <div class="flex items-center justify-between mb-4">
          <span class="text-2xl font-bold text-green-400">.app</span>
          <span class="text-xl font-semibold">$19.99</span>
        </div>
        <p class="text-slate-400 text-sm mb-4">Ideal for applications</p>
        <button onclick="addToCart('.app Domain', 19.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        <div class="flex items-center justify-between mb-4">
          <span class="text-2xl font-bold text-green-400">.dev</span>
          <span class="text-xl font-semibold">$15.99</span>
        </div>
        <p class="text-slate-400 text-sm mb-4">For developers</p>
        <button onclick="addToCart('.dev Domain', 15.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500/50 transition-colors">
        ...
        <button onclick="addToCart('.xyz Domain', 9.99)" class="w-full px-4 py-2 border border-slate-700 hover:border-green-500 hover:bg-green-500/10 rounded-lg font-semibold transition-colors">
          Add to Cart
        </button>
      </div>
    </div>
...
<section class="py-20 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8 hover:border-green-500/50 transition-colors">
        <div class="w-14 h-14 bg-green-500/10 rounded-lg flex items-center justify-center mb-6">
          <i class="fas fa-cog text-green-400 text-2xl"></i>
        </div>
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-green-900/20 to-green-900/20">
  <div class="max-w-4xl mx-auto text-center">
    ...
    <a href="#" class="inline-block px-8 py-4 bg-linear-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 rounded-lg font-semibold transition-all">
      Search Domains Now
    </a>
  </div>
</section>

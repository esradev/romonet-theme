...
<section class="py-20">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      <a href="shop.html" class="bg-linear-to-r from-green-500 to-green-500 text-white px-8 py-3 rounded-lg hover:from-green-600 hover:to-green-600 transition text-lg font-semibold">
        Browse Services
      </a>
    ...
    <div class="mt-16">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-green-500 transition">
          <div class="w-12 h-12 bg-linear-to-br from-green-500 to-green-500 rounded-lg flex items-center justify-center mb-4">
          ...
          <div class="text-2xl font-bold text-green-400 mb-4">$29<span class="text-sm text-gray-400">/month</span></div>
        ...
        <!-- Service Card 3 -->
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-green-500 transition">
          <div class="w-12 h-12 bg-linear-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mb-4">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="text-2xl font-bold text-green-400 mb-4">$12<span class="text-sm text-gray-400">/year</span></div>

...
<section class="py-20">
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div class="mb-8 flex justify-center">
      <div class="w-24 h-24 bg-linear-to-br from-sky-500 to-emerald-500 rounded-full flex items-center justify-center animate-bounce">
    ...
    <!-- Success Message -->
    <h1 class="text-5xl font-bold mb-4 bg-linear-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">
      Order Successful!
    </h1>
    ...
    <div class="bg-gray-800 rounded-xl p-8 border border-gray-700 mb-8 text-left">
      ...
      <div class="space-y-4 mb-6">
        <div class="flex justify-between items-center pb-4 border-b border-gray-700">
          ...
          <span class="font-semibold text-sky-400">#CH-2024-001234</span>
        </div>
        <div class="flex justify-between items-center pb-4 border-b border-gray-700">
      ...
      <div class="space-y-3 mb-6">
        <div class="flex justify-between items-center bg-gray-900 p-4 rounded-lg">
          ...
          <div class="text-lg font-bold text-sky-400">$79.00</div>
        </div>
        <div class="flex justify-between items-center bg-gray-900 p-4 rounded-lg">
          <div>
          ...
          <div class="text-lg font-bold text-sky-400">$39.00</div>
        </div>
      </div>
      ...
      <div class="pt-4 border-t border-gray-700">
        ...
        <div class="flex justify-between items-center text-xl font-bold pt-2 border-t border-gray-700">
          <span>Total:</span>
          <span class="text-sky-400">$129.80</span>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl p-8 border border-gray-700 mb-8">
      ...
      <div class="grid md:grid-cols-3 gap-6 text-center">
        <div>
          <div class="w-12 h-12 bg-sky-500/20 rounded-lg flex items-center justify-center mx-auto mb-3">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      <a href="dashboard.html" class="bg-linear-to-r from-sky-500 to-sky-500 text-white px-8 py-3 rounded-lg hover:from-sky-600 hover:to-sky-600 transition text-lg font-semibold">
        Go to Dashboard
      </a>
    ...
    <div class="mt-12 p-6 bg-gray-800 rounded-xl border border-gray-700">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="contact.html" class="text-sky-400 hover:text-sky-300 transition font-semibold">
          Contact Support
        </a>
        <span class="hidden sm:inline text-gray-600">|</span>
        <a href="#" class="text-sky-400 hover:text-sky-300 transition font-semibold">
          View Documentation
        </a>
        <span class="hidden sm:inline text-gray-600">|</span>
        <a href="#" class="text-sky-400 hover:text-sky-300 transition font-semibold">

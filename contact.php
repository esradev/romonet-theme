      ...
      <div class="bg-slate-900 border border-slate-800 rounded-2xl p-8 lg:p-12">
        ...
        <form class="space-y-6" x-data="{ submitted: false }" @submit.prevent="submitted = true">
          ...
          <div>
            ...
            <input type="tel" class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg focus:outline-none focus:border-green-500 transition-colors">
          </div>
          <div>
            <label class="block text-sm font-semibold mb-2">Subject</label>
            <select class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg focus:outline-none focus:border-green-500 transition-colors">
          ...
          <div>
            ...
            <textarea required rows="5" class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg focus:outline-none focus:border-green-500 transition-colors resize-none"></textarea>
          </div>
          <button type="submit" class="w-full px-8 py-4 bg-linear-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 rounded-lg font-semibold transition-all">
            Send Message
          </button>
          <div x-show="submitted" x-transition class="p-4 bg-green-500/10 border border-green-500/20 rounded-lg text-green-400 text-center">
      ...
      <div class="space-y-8">
        ...
        <div class="space-y-6">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="mailto:support@RomoNet.com" class="text-slate-400 hover:text-green-400 transition-colors">support@RomoNet.com</a>
              <br>
              <a href="mailto:sales@RomoNet.com" class="text-slate-400 hover:text-green-400 transition-colors">sales@RomoNet.com</a>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="tel:+1234567890" class="text-slate-400 hover:text-green-400 transition-colors">+1 (234) 567-890</a>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <button class="px-6 py-2 bg-green-600 hover:bg-green-700 rounded-lg text-sm font-semibold transition-colors">
                Start Chat
              </button>
            </div>
          </div>
        ...
        <div class="pt-8">
          ...
          <div class="flex gap-4">
            <a href="#" class="w-12 h-12 bg-slate-900 border border-slate-800 hover:border-green-500 hover:bg-green-500/10 rounded-lg flex items-center justify-center transition-colors">

...
<section class="relative overflow-hidden">
  <div class="absolute inset-0 bg-linear-to-br from-sky-600/10 via-transparent to-sky-600/10"></div>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        <div class="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/20 rounded-full px-4 py-2 mb-6">
          ...
          <span class="text-sm text-sky-300">Trusted by 50,000+ businesses worldwide</span>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-12">
          <a href="pricing.html" class="bg-linear-to-r from-sky-600 to-sky-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-sky-500 hover:to-sky-500 text-center">
            Start Free Trial
          </a>
      ...
      <div class="relative">
        <svg class="absolute -top-10 -right-10 w-32 h-32 text-sky-600/20" fill="currentColor" viewBox="0 0 100 100">
          <circle cx="50" cy="50" r="50" />
        </svg>
        <div class="absolute inset-0 bg-linear-to-r from-sky-600 to-sky-600 rounded-2xl blur-3xl opacity-20"></div>
...
<section class="py-20 lg:py-32">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      <!-- SMS Panel -->
      <a href="service-sms.html" class="feature-card group bg-slate-900 border border-slate-800 rounded-2xl p-8 hover:border-sky-500/50">
        <div class="w-14 h-14 bg-linear-to-br from-sky-500 to-sky-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <div class="flex items-center text-sky-400 font-medium group-hover:gap-3 gap-2 transition-all">
      ...
      <!-- Hosting -->
      <a href="service-hosting.html" class="feature-card group bg-slate-900 border border-slate-800 rounded-2xl p-8 hover:border-sky-500/50">
        <div class="w-14 h-14 bg-linear-to-br from-sky-500 to-sky-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
        <div class="w-12 h-12 bg-sky-500/10 rounded-lg flex items-center justify-center mb-4">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
      <div class="relative text-center">
        <div class="w-16 h-16 bg-linear-to-br from-sky-500 to-sky-600 rounded-2xl flex items-center justify-center text-2xl font-bold text-white mx-auto mb-6">
          1
        </div>
    ...
    <div class="grid md:grid-cols-3 gap-8">
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8">
        ...
        <div class="flex items-center gap-3">
          <div class="w-12 h-12 bg-linear-to-br from-sky-500 to-sky-500 rounded-full flex items-center justify-center text-white font-bold">
            SJ
          </div>
          <div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-8">
        ...
        <div class="flex items-center gap-3">
          <div class="w-12 h-12 bg-linear-to-br from-sky-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">
            MC
          </div>
          <div>
...
<section class="py-20 lg:py-32">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-linear-to-r from-sky-800/80 to-sky-950/80 rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
      <div class="absolute inset-0 bg-linear-to-br from-sky-600/50 to-sky-600/50"></div>
      ...
      <div class="relative z-10">
        ...
        <p class="text-xl text-sky-100 mb-8 max-w-2xl mx-auto leading-relaxed">
          Join thousands of businesses already using RomoNet to scale their operations.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="pricing.html" class="bg-white text-sky-600 px-8 py-4 rounded-lg font-bold hover:bg-sky-50 inline-block">
            Start Free Trial
          </a>
        ...
        <p class="text-sky-100 text-sm mt-6">
